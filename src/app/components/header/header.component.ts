...
export class HeaderComponent {
  ...
  // Le constructeur injecte le service Router pour pouvoir naviguer entre les pages
  ...
  onSearch() {
    ...
    if (this.searchQuery.trim()) {
      // Redirige vers la page /recherche avec le mot-clé dans l'URL comme paramètre (q=motclé)
